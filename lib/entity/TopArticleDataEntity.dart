...
class TopArticleEntity{
  ...
  TopArticleEntity({this.data, this.errorCode, this.errorMsg});

  TopArticleEntity.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<ArticleItemEntity>();
      json['data'].forEach((v) {
        data.add(new ArticleItemEntity.fromJson(v));
      });
    }
...
class ArticleItemEntity {
  ...
  ArticleItemEntity.fromJson(Map<String, dynamic> json) {
